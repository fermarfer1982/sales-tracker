...
export const clientService = {
  ...
  importPreview: (csvText) => api.post('/clients/import-preview', { csvText }),
  importCsv: (csvText) => api.post('/clients/import', { csvText }),
...
export const activityService = {
  ...
  updateFollowUp: (id, data) => api.put(`/activities/${id}/follow-up`, data),
  completeFollowUp: (id) => api.post(`/activities/${id}/follow-up/complete`),
...
export const catalogService = {
  ...
  delete: (type, id) => api.delete(`/catalogs/${type}/${id}`),
};
...
export const userService = {
  ...
  importPreview: (csvText) => api.post('/users/import-preview', { csvText }),
  importCsv: (csvText) => api.post('/users/import', { csvText }),
