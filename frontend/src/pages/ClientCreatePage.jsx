...
export default function ClientCreatePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const locations = geoData ? [{ ...geoData, label: 'finca1' }] : [];
      await clientService.create({ clientType, legalName, taxId: taxId || null, province, city, zoneId, segmentId, phone: phone || null, email: email || null, notes: notes || null, geo: geoData, locations });
      navigate('/clients');
    } catch (err) {
            ...
            <form onSubmit={handleSubmit}>
              <div className="row g-2 mb-3">
                ...
                <div className="col-12">
                  ...
                  <input type="text" className="form-control" value={taxId} onChange={e => setTaxId(e.target.value)} required={clientType === 'direct'} placeholder="B12345674" />
                </div>
              </div>
              <div className="row g-2 mb-3">
                <div className="col-6">
              ...
              <div className="mb-3 form-check">
                ...
                <label className="form-check-label" htmlFor="saveGeo">
                  Guardar mi ubicación actual como finca1 del cliente
                </label>
