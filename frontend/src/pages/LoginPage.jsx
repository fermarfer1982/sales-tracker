...
import logoSalesTracker from '../assets/logo-sales-tracker.svg';
    ...
    <div className="d-flex justify-content-center align-items-center vh-100">
      <div className="card shadow-sm p-4" style={{ width: '100%', maxWidth: 400 }}>
        ...
        <div className="text-center mb-4">
          <img src={logoSalesTracker} alt="Logo Sales Tracker" width={88} height={88} className="mb-2" style={{ borderRadius: '50%' }} />
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label className="form-label fw-semibold" htmlFor="login-password">Contraseña</label>
            <input
              id="login-password"
              type="password"
              className="form-control form-control-lg"
